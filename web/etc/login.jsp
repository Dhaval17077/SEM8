     ...
     <div class="container">
      <form class="form-login" action="loginprocess.jsp" method="post">
        ...
        <div class="login-wrap">
          <input type="text" name="email" id="email" class="form-control" placeholder="Email ID" autofocus required="required">
          <br>
        ...
        <!-- Modal -->
              ...
              <form class="form-login" action="mail.jsp" method="post">
