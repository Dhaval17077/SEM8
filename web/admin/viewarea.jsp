<jsp:include page="header.jsp"/>
 ...
 <section id="main-content">
      <section class="wrapper">
        <h3><i class="fa fa-angle-right"></i> List Of Areas</h3>
        <div class="row mb">
          <!-- page start-->
...
">              <table cellpadding="0" cellspacing="0" border="0" class="display table table-bordered" id="hidden-table-info">
                <thead>
                  <tr>
                    <th><i class="fa fa-bullhorn"></i> Area ID</th>
...
%>     
                  ...
                  <tr class="gradeA">
                    ...
                    <td>
                    <% out.println(rs1.getString("area_id"));%>
                    </td>
                    <td>	
                    <% out.println(rs1.getString("area_name"));%>
                    </td>
                     <td>
                          <a href="addarea.jsp?areaid=<% out.println(rs1.getString("area_id"));%>">

                         <button class="btn btn-primary btn-xs"><i class="fa fa-pencil"></i></button>
                   </a>  </td>
                     <td>
                             <a href="deletearea.jsp?areaid=<% out.println(rs1.getString("area_id"));%>">
          ...
          <!-- page end-->
                 ...
                 <div class="form-send">
                <button type="submit" class="btn btn-large btn-primary"><a href="addarea.jsp">ADD AREA</a></button>
                </div>
            </form>
        <!-- /row -->
      </section>
