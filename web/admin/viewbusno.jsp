<jsp:include page="header.jsp"/>
 ...
 <section id="main-content">
      <section class="wrapper">
        <h3><i class="fa fa-angle-right"></i> List Of Bus Number</h3>
        <div class="row mb">
          <!-- page start-->
...
">              <table cellpadding="0" cellspacing="0" border="0" class="display table table-bordered" id="hidden-table-info">
                <thead>
                  <tr>
                    ...
                    <th class="hidden-phone"><i class="fa fa-question-circle"></i> Bus Name</th>
...
%>     
                  ...
                  <tr class="gradeA">
                    ...
                    <td>
                    <% out.println(rs1.getString("bus_id"));%>
                    </td>
                    <td>	
                    <% out.println(rs1.getString("bus_name"));%>
                    </td>
                     <td>
                          <a href="addbusno.jsp?busid=<% out.println(rs1.getString("bus_id"));%>">

                         <button class="btn btn-primary btn-xs"><i class="fa fa-pencil"></i></button>
                   </a>  </td>
                     <td>
                             <a href="deletebusno.jsp?busid=<% out.println(rs1.getString("bus_id"));%>">
          ...
          <!-- page end-->
                 ...
                 <div class="form-send">
                <button type="submit" class="btn btn-large btn-primary"><a href="addbusno.jsp">ADD BUS NUMBER</a></button>
                </div>
            </form>
        <!-- /row -->
      </section>
