...
<head>
 ...
 <section id="main-content">
      <section class="wrapper">
        <h3><i class="fa fa-angle-right"></i> List Of Pass Application</h3>
        <div class="row mb">
          <!-- page start-->
...
">              <table cellpadding="0" cellspacing="0" border="0" class="display table table-bordered" id="hidden-table-info">
                <thead>
                  <tr>
                    <th><i class="fa fa-bullhorn"></i> Application ID</th>
                    <th><i class="fa fa-bullhorn"></i> Customer ID</th> 
                    <th><i class=" fa fa-edit"></i> Account ID</th>
                    <th class="hidden-phone"><i class="fa fa-question-circle"></i> Student Name</th>
                    <th><i class="fa fa-bullhorn"></i> Student Father Name</th>
                    <th><i class="fa fa-edit"></i> Date of Birth</th>
                    <th><i class=" fa fa-edit"></i> Display</th>
                  </tr>
                </thead>
                <tbody>
...
String sql="select * from  passreg where pass_type='Studentpass'";
...
%>     
              ...
              <% out.println(rs1.getString("application_no"));%>
                    ...
                    <div class="form-send">
                      <button type="submit" class="btn btn-large btn-primary"><a href="displaystupass.jsp?accid=<%=rs1.getString("application_no")%>">VIEW PASS</a></button>
                    </div>
                 </div>      
                    </td>
