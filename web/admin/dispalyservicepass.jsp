...
String sql="select * from  passreg where application_no="+request.getParameter("accid")+" and pass_type='Servicepass' ";
...
%>
                ...
                <button type="submit" class="btn btn-large btn-primary"><a href="viewservicepassdoc.jsp?docid=<%=rs2.getString("application_no")%>">CUSTOMER DOCUMENTS</a></button>
                <%}%>
                <%
...
if(rs.next())
    {
        if(rs.getString("status")!=null)
         {
%>
                <button type="submit" class="btn btn-large btn-primary"><a href="generatepassservice.jsp?docid=<%=rs.getString("application_no")%>">GENERATE PASS</a></button>
                </div>
            </form>
