...
String sql="select * from passreg  inner join payment on passreg.application_no=payment.application_no where passreg.application_no="+request.getParameter("docid")+" and passreg.pass_type='ServicePass' ";
