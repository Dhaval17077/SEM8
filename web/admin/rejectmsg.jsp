...
<form class="contact-form php-mail-form" action="rejectdoc.jsp" role="form" method="POST">
...
<div class="validate"></div>
              ...
              <div class="form-send">
                      ...
                      <button type="submit" class="btn btn-large btn-primary"><a href="viewstupassdoc.jsp?docid1=<%=rs1.getString("doc_id")%>&&docid=<%=rs1.getString("application_no")%>" style="color: white;">BACK</a></button>
                 </div>
