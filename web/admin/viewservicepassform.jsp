                ...
                <thead>
                  <tr>
                   ...
                   <th><i class=" fa fa-edit"></i> Account ID</th>
                    ...
                    <th><i class="fa fa-bullhorn"></i> Father Name</th>
...
String sql="select * from passreg where pass_type='Servicepass'";
...
%>     
                  ...
                  <% out.println(rs1.getString("application_no"));%>        
                    ...
                    <div class="form-send">
                      <button type="submit" class="btn btn-large btn-primary"><a href="dispalyservicepass.jsp?accid=<%=rs1.getString("application_no")%>">VIEW PASS</a></button>
                    </div>
                 </div>      
                    </td>
