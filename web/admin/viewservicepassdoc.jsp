                  ...
                  <tr class="gradeA">
                    ...
                    %>
                     ...
                     %>
                      ...
                      <td>
 <a href="approvedocser.jsp?docid1=<%=rs1.getString("doc_id")%>&&docid=<%=rs1.getString("application_no")%>" style="color: white;">
                    ...
                    %>
                     ...
                     %>
                      ...
                      %>
                     <td>
 <a href="rejectmsgser.jsp?docid1=<%=rs1.getString("doc_id")%>&&docid=<%=rs1.getString("application_no")%>" style="color: white;">
