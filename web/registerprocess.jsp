...
if(rs.next())
    ...
    {
String query = "insert into account(account_name,account_email,account_number,account_password,account_repassword,account_type) values('"+fname+"','"+email+"','"+mnumber+"','"+password+"','"+cpassword+"','user')";
statement.executeUpdate(query);
response.sendRedirect("login.jsp?st=success");
     out.println("fresh");
