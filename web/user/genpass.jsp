...
<div class="dashboard-content booking-trips">
                                		<h2 class="dash-content-title">Pass that You have Applied!</h2>
                                        <div class="dashboard-listing booking-listing">
                                        	<div class="dash-listing-heading">
                                                <div class="custom-radio">
                                                    <input type="radio" id="radio01" name="radio" checked/>
                                                    <label for="radio01"><span></span>Download Pass</label>
...
String sql1="select * from tbl_doc where application_no="+request.getParameter("appnu")+" and doc_type='Profile Photo' ";
//out.println(sql1);
...
%> 
	...
	<div class="id-card-hook"></div>
        <div class="id-card-holder" id="html-content-holder">
			...
			<div class="photo">
             <img src="../admin/img/<%out.println(rs2.getString("doc_name"));%>" alt=""  margin-left="210" height="100" width="120"></img>
			</div>
                 
                
<%
    }
String sql="select * from passreg  inner join payment on passreg.application_no=payment.application_no where passreg.application_no="+request.getParameter("appnu")+"";
...
String sql13="select * from  passreg  where application_no="+request.getParameter("appnu")+"";
rs5=statement.executeQuery(sql13);
if(rs5.next())
    {
        String type=rs5.getString("pass_type");  

        if(type.equals("Studentpass"))
        {
%>
			<hr>
                        <p style="text-align: center;">College Name: <% out.println(rs5.getString("sc_name"));%></p>
 <% }
        else
                    {
        %>
               ...
               <tbody>
                 ...
                 <div class="form-send">
                <button id="btn-Preview-Image" type="button" value="Preview" class="btn11">PREVIEW</button>
                <button class="btn11"><a id="btn-Convert-Html2Image" href="#">Download</a></button>
                 </div>
                                              </form>
               
      </section>
    </section>
  <div id="previewImage" name="passimg" style="text-align: center; margin-left: 8px; margin-top: 80px;"></div>
  </div></div></div>
 <br>
 <br>
<script> 
