...
int count=0;
String sql1="select * from  tbl_doc where application_no='"+appn+"' and pass_type='Servicepass' ";
...
%> 
  <form action="servicedocprocess.jsp" class="form-horizontal style-form" method="post">
...
<table class="table table-hover" style="margin-top: -25px; margin-bottom: 17px;">
   ...
   <button class="btn btn-orange" style="width: 150px; margin-top: -30px; margin-bottom: 20px; margin-left: 468px; height: 40px;">Next</button> 
    </section></form>
</div> 
 </div>
 </div>
...
String sql="select * from  tbl_doc where application_no='"+appn+"' and pass_type='Servicepass' ";
...
<tr>
    ...
    <td>   <img class="img-responsive" src="../admin/img/<%out.println(rs.getString("doc_name"));%>" alt="" style="height:160px; width: 190px"> </td>
      ...
      <td>     <% out.println(rs.getString("doc_type"));%> </td>
       ...
       <td>    <a href="deletedoc1.jsp?docid=<% out.println(rs.getString("doc_id"));%>">
