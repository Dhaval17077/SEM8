...
<div class="dashboard-content booking-trips">
        ...
        <div class="student box">                                
            <form method="post" action="renewprocessstu.jsp">
...
String sql="select * from  passreg where mnumber="+mno+" and pass_type='Studentpass' ";
...
%>                                          
					...
					<input type="text" name="email" value="<%out.println(rs1.getString("email"));%>" onblur="checkEmail(this)" style="width:200px" id="emailId" required>
                        		...
                        		<td width="23%"><textarea name="raddress" cols="20" rows="3" value="" style="width:200px" id="raddress" required></textarea>
                                        ...
                                        <td width="23%"><input type="text" name="scname" value="" style="width:200px" id="instcollname" required></td>
                                       </tr>
                                           <tr class="firstrow">
                                	<th width="18%">&nbsp;<span class="num">3.2</span> Address: <font color="red">*</font></th>
                        		<td width="23%"><textarea name="scaddress" value="" cols="20" rows="3" style="width:200px" id="scaddress" required></textarea>
                                         </td>
