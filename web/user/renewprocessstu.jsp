...
statement = connection.createStatement();
 ...
 String applic=(String)session.getAttribute("appli"); 
    ...
    String query = "update passreg set account_id='"+account+"',name='"+name+"',fname='"+fname+"',dob='"+dobname+"',gender='"+radio+"',aadharno='"+aadharno+"',mnumber='"+mnumber+"',email='"+email+"',r_address='"+raddress+"',r_pincode='"+pincode+"',sc_name='"+scname+"',sc_address='"+scaddress+"',sc_pincode='"+pincode2+"',pass_m_a='"+selectmonth+"',pass_type='Studentpass' where application_no='"+applic+"' ";
      out.println();     
